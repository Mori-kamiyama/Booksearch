export type FrameSkipReason = 'warming_up' | 'blurred' | 'glare' | 'unchanged' | 'rate_limited'
...
export const LIVE_SCAN_DEFAULTS = { evaluationFps: 15, maxSendFps: 1, minBlur: 80, minDifference: 12, maxGlareRatio: 0.18 }
